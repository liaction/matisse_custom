...
public class MatisseActivity extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setVisibility(mSpec.showToolBar ? View.VISIBLE : View.GONE);
        ...
        mButtonCancel.setVisibility(mSpec.showToolBar ? View.GONE : View.VISIBLE);
        if (!mSpec.showToolBar) {
